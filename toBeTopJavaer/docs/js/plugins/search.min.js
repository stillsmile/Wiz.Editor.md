!function () {
    ...
    function o(e, n, t, o) {
        ...
        return r.forEach(function (n) {
            if ("heading" === n.type && n.depth <= o) i = t.toURL(e, {id: a(n.text)}), s[i] = {
                slug: i,
                title: n.text,
                body: ""
            }; else {
    ...
    function i(n) {
        ...
        for (var r = 0; r < o.length; r++) !function (n) {
            ...
            if (c && l && (i.forEach(function (n, t) {
                ...
                if (i = c && c.search(o), r = l && l.search(o), i < 0 && r < 0) a = !1; else {
                    a = !0, r < 0 && (r = 0);
                    var f = 0, d = 0;
    ...
    function r(e, i) {
        ...
        if (g = JSON.parse(localStorage.getItem("docsify.search.index")), a) g = {}; else if (!r) return;
        var s = r ? n(i.router) : e.paths, c = s.length, l = 0;
    ...
    function s(e, n) {
        ...
        var t = '<input type="search" value="' + n + '" /><div class="results-panel"></div></div>',
            o = Docsify.dom.create("div", t), i = Docsify.dom.find("aside");
    ...
    function l() {
        var e, n = Docsify.dom.find("div.search"), t = Docsify.dom.find(n, "input");
    ...
    function f(e, n) {
        ...
        if (t) if ("string" == typeof e) t.placeholder = e; else {
    ...
    var h, g = {}, y = "",
        m = {placeholder: "Type to search", noData: "No Results!", paths: "auto", depth: 2, maxAge: 864e5},
        v = function (e, n) {
            var t = Docsify.util, o = n.config.search || m;
