!function () {
    ...
    }), l = Object.prototype.hasOwnProperty, b = Object.assign || function (e) {
    ...
    var m = document, v = m.body, y = m.head;
    ...
    var i, r = Object.hasOwnProperty, O = Object.setPrototypeOf, L = Object.isFrozen, F = Object.getPrototypeOf,
        z = Object.getOwnPropertyDescriptor, Re = Object.freeze, M = Object.seal, N = Object.create,
        P = "undefined" != typeof Reflect && Reflect, D = (D = P.apply) || function (e, t, n) {
            return e.apply(t, n)
        }, Re = Re || function (e) {
            return e
        }, M = M || function (e) {
        ...
        }, $e = j(Array.prototype.forEach), Ce = j(Array.prototype.pop), Oe = j(Array.prototype.push),
        Le = j(String.prototype.toLowerCase), Fe = j(String.prototype.match), ze = j(String.prototype.replace),
        Me = j(String.prototype.indexOf), Ne = j(String.prototype.trim), Pe = j(RegExp.prototype.test),
    ...
    var He = Re(["a", "abbr", "acronym", "address", "area", "article", "aside", "audio", "b", "bdi", "bdo", "big", "blink", "blockquote", "body", "br", "button", "canvas", "caption", "center", "cite", "code", "col", "colgroup", "content", "data", "datalist", "dd", "decorator", "del", "details", "dfn", "dialog", "dir", "div", "dl", "dt", "element", "em", "fieldset", "figcaption", "figure", "font", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "html", "i", "img", "input", "ins", "kbd", "label", "legend", "li", "main", "map", "mark", "marquee", "menu", "menuitem", "meter", "nav", "nobr", "ol", "optgroup", "option", "output", "p", "picture", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp", "section", "select", "shadow", "small", "source", "spacer", "span", "strike", "strong", "style", "sub", "summary", "sup", "table", "tbody", "td", "template", "textarea", "tfoot", "th", "thead", "time", "tr", "track", "tt", "u", "ul", "var", "video", "wbr"]),
        ...
        Je = M(/\{\{[\s\S]*|[\s\S]*\}\}/gm), et = M(/<%[\s\S]*|[\s\S]*%>/gm), tt = M(/^data-[\-\w.\u00B7-\uFFFF]/),
        nt = M(/^aria-[\-\w]+$/),
        rt = M(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),
        it = M(/^(?:\w+script|data):/i), at = M(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),
    ...
    var q, H, U = function t(e) {
        ...
        var l = s.document, a = s.document, u = s.DocumentFragment, n = s.HTMLTemplateElement, p = s.Node,
            o = s.Element, r = s.NodeFilter, i = s.NamedNodeMap,
            d = void 0 === i ? s.NamedNodeMap || s.MozNamedAttrMap : i, h = s.Text, f = s.Comment, g = s.DOMParser,
            e = s.trustedTypes, i = o.prototype, m = qe(i, "cloneNode"), v = qe(i, "nextSibling"),
            b = qe(i, "childNodes"), y = qe(i, "parentNode");
        "function" != typeof n || (n = a.createElement("template")).content && n.content.ownerDocument && (a = n.content.ownerDocument);
        var k = ct(e, l), w = k && ee ? k.createHTML("") : "", x = a.implementation, _ = a.createNodeIterator,
            S = a.getElementsByTagName, A = a.createDocumentFragment, T = l.importNode, E = {};
        try {
        ...
        var C, O = Je, L = et, F = tt, z = nt, M = it, N = at, P = rt, D = null,
            I = Ie({}, [].concat(st(He), st(Ue), st(Be), st(Ge), st(Ve))), j = null,
            q = Ie({}, [].concat(st(Ye), st(Xe), st(Ke), st(Qe))), H = null, U = null, B = !0, Z = !0, G = !1, W = !1,
            V = !1, Y = !1, X = !1, K = !1, Q = !1, J = !0, ee = !1, te = !0, ne = !0, re = !1,
            ...
            ae = null, oe = Ie({}, ["audio", "video", "img", "source", "image", "track"]), se = null,
            le = Ie({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "summary", "title", "value", "style", "xmlns"]),
            ce = null, ue = a.createElement("form"), pe = Ie({}, ["mi", "mo", "mn", "ms", "mtext"]),
            de = Ie({}, ["foreignobject", "desc", "title", "annotation-xml"]), he = Ie({}, Ue);
        Ie(he, Be), Ie(he, Ze);
        var fe = Ie({}, Ge);
        Ie(fe, We);
        ...
        function we(e) {
            ...
            if (D[n] && !H[n]) return e instanceof o && !function (e) {
                ...
                var n = Le(e.tagName), r = Le(t.tagName);
            ...
            }(e) || ("noscript" === n || "noembed" === n) && Pe(/<\/no(script|embed)/i, e.innerHTML) ? (ge(e), 1) : (W && 3 === e.nodeType && (t = e.textContent, t = ze(t, O, " "), t = ze(t, L, " "), e.textContent !== t && (Oe(c.removed, {element: e.cloneNode()}), e.textContent = t)), ke("afterSanitizeElements", e, null), 0);
        ...
        function _e(e) {
            ...
            if (r) {
                for (var i = {attrName: "", attrValue: "", keepAttr: !0, allowedAttributes: j}, n = r.length; n--;) {
                    var a = (l = r[n]).name, o = l.namespaceURI, t = Ne(l.value), s = Le(a);
                    if (i.attrName = s, i.attrValue = t, i.keepAttr = !0, i.forceKeepAttr = void 0, ke("uponSanitizeAttribute", e, i), t = i.attrValue, !i.forceKeepAttr && (me(a, e), i.keepAttr)) if (Pe(/\/>/i, t)) me(a, e); else {
                        W && (t = ze(t, O, " "), t = ze(t, L, " "));
        ...
        var Ae = "http://www.w3.org/1998/Math/MathML", Te = "http://www.w3.org/2000/svg",
        ...
        return c.sanitize = function (e, t) {
            ...
            if (Y || $(t), c.removed = [], "string" == typeof e && (re = !1), !re) if (e instanceof p) 1 === (t = (r = ve("\x3c!----\x3e")).ownerDocument.importNode(e, !0)).nodeType && "BODY" === t.nodeName || "HTML" === t.nodeName ? r = t : r.appendChild(t); else {
            ...
            if (K) {
                if (Q) for (a = A.call(r.ownerDocument); r.firstChild;) a.appendChild(r.firstChild); else a = r;
    ...
    var Q = decodeURIComponent, J = encodeURIComponent;
    ...
    var pt = Ee(function (t) {
        ...
        }), dt = (pt.defaults, pt.getDefaults, pt.changeDefaults, /[&<>"']/), ht = /[&<>"']/g, ft = /[<>"']|&(?!#?\w+;)/,
        gt = /[<>"']|&(?!#?\w+;)/g, mt = {"&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;"};
    ...
    var yt = /(^|[^\[])\^/g;
    var kt = /[^\w:]/g, wt = /^$|^[a-z][a-z0-9+.-]*:|^[?#]/i;
    var xt = {}, _t = /^[^:]+:\/*[^/]*$/, St = /^([^:]+:)[\s\S]*$/, At = /^([^:]+:\/*[^/]*)[\s\S]*$/;
    ...
    var Rt = function (e, t) {
        ...
        return n + e
    }, Nt = pt.defaults, Pt = Et, Dt = zt, It = Rt, jt = Mt;

    function qt(e, t, n) {
        var r = t.href, i = t.title ? It(t.title) : null, t = e[1].replace(/\\([\[\]])/g, "$1");
        ...
        return e.prototype.space = function (e) {
            ...
            if (t) {
                ...
                if (!this.options.pedantic && /^</.test(n)) {
                    ...
                    var r = jt(t[2], "()");
                    -1 < r && (a = (0 === t[0].indexOf("!") ? 5 : 4) + t[1].length + r, t[2] = t[2].substring(0, r), t[0] = t[0].substring(0, a).trim(), t[3] = "")
                }
                var i, r = t[2], a = "";
            ...
            if (n = this.rules.inline.url.exec(e)) {
                if ("@" === n[2]) i = "mailto:" + (r = It(this.options.mangle ? t(n[0]) : n[0])); else {
    ...
    var zt = {block: Ct, inline: zt}, Ut = pt.defaults, Bt = zt.block, Zt = zt.inline, Gt = M;
    ...
    var Yt = function () {
        ...
        return e.rules.get = function () {
            ...
            var r, i, a, o;
            for (void 0 === t && (t = []), void 0 === n && (n = !0), this.options.pedantic && (e = e.replace(/^ +$/gm, "")); e;) if (r = this.tokenizer.space(e)) e = e.substring(r.raw.length), r.type && t.push(r); else if (r = this.tokenizer.code(e, t)) e = e.substring(r.raw.length), r.type ? t.push(r) : ((o = t[t.length - 1]).raw += "\n" + r.raw, o.text += "\n" + r.text); else if (r = this.tokenizer.fences(e)) e = e.substring(r.raw.length), t.push(r); else if (r = this.tokenizer.heading(e)) e = e.substring(r.raw.length), t.push(r); else if (r = this.tokenizer.nptable(e)) e = e.substring(r.raw.length), t.push(r); else if (r = this.tokenizer.hr(e)) e = e.substring(r.raw.length), t.push(r); else if (r = this.tokenizer.blockquote(e)) e = e.substring(r.raw.length), r.tokens = this.blockTokens(r.text, [], n), t.push(r); else if (r = this.tokenizer.list(e)) {
            ...
            if (this.tokens.links) {
                ...
                if (0 < c.length) for (; null != (a = this.tokenizer.rules.inline.reflinkSearch.exec(l));) c.includes(a[0].slice(a[0].lastIndexOf("[") + 1, -1)) && (l = l.slice(0, a.index) + "[" + Gt("a", a[0].length - 2) + "]" + l.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))
            }
            ...
            for (; e;) if (o || (s = ""), o = !1, i = this.tokenizer.escape(e)) e = e.substring(i.raw.length), t.push(i); else if (i = this.tokenizer.tag(e, n, r)) e = e.substring(i.raw.length), n = i.inLink, r = i.inRawBlock, t.push(i); else if (i = this.tokenizer.link(e)) e = e.substring(i.raw.length), "link" === i.type && (i.tokens = this.inlineTokens(i.text, [], !0, r)), t.push(i); else if (i = this.tokenizer.reflink(e, this.tokens.links)) e = e.substring(i.raw.length), "link" === i.type && (i.tokens = this.inlineTokens(i.text, [], !0, r)), t.push(i); else if (i = this.tokenizer.strong(e, l, s)) e = e.substring(i.raw.length), i.tokens = this.inlineTokens(i.text, [], n, r), t.push(i); else if (i = this.tokenizer.em(e, l, s)) e = e.substring(i.raw.length), i.tokens = this.inlineTokens(i.text, [], n, r), t.push(i); else if (i = this.tokenizer.codespan(e)) e = e.substring(i.raw.length), t.push(i); else if (i = this.tokenizer.br(e)) e = e.substring(i.raw.length), t.push(i); else if (i = this.tokenizer.del(e)) e = e.substring(i.raw.length), i.tokens = this.inlineTokens(i.text, [], n, r), t.push(i); else if (i = this.tokenizer.autolink(e, Vt)) e = e.substring(i.raw.length), t.push(i); else if (n || !(i = this.tokenizer.url(e, Vt))) {
                if (i = this.tokenizer.inlineText(e, r, Wt)) e = e.substring(i.raw.length), s = i.raw.slice(-1), o = !0, t.push(i); else if (e) {
    ...
    }(), Xt = pt.defaults, Kt = Ot, Qt = Rt, Jt = function () {
        function e(e) {
            this.options = e || Xt
        }
    ...
    }(), nn = pt.defaults, rn = $t, an = function () {
        function n(e) {
    ...
    }(), on = Ft, sn = P, ln = Rt, Rt = pt.getDefaults, cn = pt.changeDefaults, pt = pt.defaults;
        ...
        var o, s, l, c, u, r, t, i = function (l) {
            var c = /\blang(?:uage)?-([\w-]+)\b/i, t = 0, C = {
                ...
                highlightElement: function (e, t, n) {
                    var r = C.util.getLanguage(e), i = C.languages[r];
                ...
                tokenize: function (e, t) {
                    ...
                    var i = new a;
                    return F(i, i.head, e), function e(t, n, r, i, a, o) {
                                ...
                                for (var m = p.pattern || p, v = i.next, b = a; v !== n.tail && !(o && b >= o.reach); b += v.value.length, v = v.next) {
                                    ...
                                    if (!(y instanceof O)) {
                                        ...
                                        if (f) {
                                            ...
                                            var x = k.index, _ = k.index + k[0].length, S = b;
                                        ...
                                        var x = k.index, T = k[0], E = y.slice(0, x), R = y.slice(x + T.length),
                                            $ = b + y.length;
                                        o && $ > o.reach && (o.reach = $);
                                        var y = v.prev;
    ...
    var An = {}, Tn = {
        ...
        var e = i.markdown || {}, o = p(e) ? e(pn, t) : (pn.setOptions(b(e, {renderer: b(t, e.renderer)})), pn);
    ...
    En.prototype.compileEmbed = function (e, t) {
        ...
        var o, s, l, c, u, p, e = new pn.Renderer, t = this.linkTarget, n = this.linkRel, a = this.router,
            r = this.contentBase, d = this, i = {};
        return i.heading = e.heading = function (e, t) {
            var n = kn(e), r = n.str, i = n.config, e = {level: t, title: wn(r)};
            ...
            void 0 === t && (t = "");
            var r = [], i = kn(t), a = i.str, i = i.config;
            ...
            var r = e, i = [], a = kn(t), o = a.str, a = a.config;
        ...
        if (e) i = this.compile(e); else {
            for (var a = 0; a < n.length; a++) if (n[a].ignoreSubHeading) {
                var o = n[a].level;
                n.splice(a, 1);
    ...
    function On(e, r) {
        var a = e.compiler, i = e.raw;
        void 0 === i && (i = "");
        var t = e.fetch, e = Cn[i];
        if (e) {
            var n = e.slice();
            return n.links = e.links, r(n)
        }
        var n = a._marked, o = n.lexer(i), s = [], l = n.Lexer.rules.inline.link, c = o.links;
        ...
        var u = [];
        !function (e, a) {
            var t, n = e.embedTokens, o = e.compile, s = (e.fetch, 0), l = 1;
            ...
            for (; t = n[s++];) {
                var r = function (i) {
                    return function (e) {
                        ...
                        }]).links = {} : (t = [{type: "html", text: e}]).links = {}), a({
                            token: i,
                            embedToken: t
                        }), ++l >= s && a({})
                    }
    ...
    function Fn(e) {
        ...
        var n = this.config, r = k(".markdown-section"),
            i = "Vue" in window && window.Vue.version && Number(window.Vue.version.charAt(0));
        if (e = e || "<h1>404 - Not found</h1>", "Vue" in window) for (var a = 0, o = w(".markdown-section > *").filter(t); a < o.length; a += 1) {
            var s = o[a];
    ...
    function zn(e) {
        ...
        c ? (t.repo && (u += (a = t.repo, s = t.cornerExternalLinkTarge, a ? (/\/\//.test(a) || (a = "https://github.com/" + a), '<a href="' + (a = a.replace(/^git\+/, "")) + '" target="' + (s = s || "_blank") + '" class="github-corner" aria-label="View source on Github"><svg viewBox="0 0 250 250" aria-hidden="true"><path d="M0,0 L115,115 L130,115 L142,142 L250,250 L250,0 Z"></path><path d="M128.3,109.0 C113.8,99.7 119.0,89.6 119.0,89.6 C122.0,82.7 120.5,78.6 120.5,78.6 C119.2,72.0 123.4,76.3 123.4,76.3 C127.3,80.9 125.5,87.3 125.5,87.3 C122.9,97.6 130.6,101.9 134.4,103.2" fill="currentColor" style="transform-origin: 130px 106px;" class="octo-arm"></path><path d="M115.0,115.0 C114.9,115.1 118.7,116.5 119.8,115.4 L133.7,101.6 C136.9,99.2 139.9,98.4 142.2,98.6 C133.8,88.0 127.5,74.4 143.8,58.0 C148.5,53.4 154.0,51.2 159.7,51.0 C160.3,49.4 163.2,43.6 171.4,40.1 C171.4,40.1 176.1,42.5 178.8,56.2 C183.1,58.6 187.2,61.8 190.9,65.4 C194.5,69.0 197.7,73.2 200.1,77.6 C213.8,80.2 216.3,84.9 216.3,84.9 C212.7,93.1 206.9,96.0 205.4,96.6 C205.1,102.4 203.0,107.8 198.3,112.5 C181.9,128.9 168.3,122.5 157.7,114.1 C157.9,116.9 156.7,120.9 152.7,124.9 L141.0,136.5 C139.8,137.7 141.6,141.9 141.8,141.8 Z" fill="currentColor" class="octo-body"></path></svg></a>') : "")), t.coverpage && (u += (i = ", 100%, 85%", '<section class="cover show" style="background: ' + ("linear-gradient(to left bottom, hsl(" + Math.floor(255 * Math.random()) + i + ") 0%,hsl(" + Math.floor(255 * Math.random()) + i + ") 100%)") + '"><div class="mask"></div><div class="cover-main">\x3c!--cover--\x3e</div></section>')), t.logo && (i = /^data:image/.test(t.logo), n = /(?:http[s]?:)?\/\//.test(t.logo), r = /^\./.test(t.logo), i || n || r || (t.logo = le(e.router.getBasePath(), t.logo))), u += (r = (n = t).name ? n.name : "", "<main>" + ('<button class="sidebar-toggle" aria-label="Menu"><div class="sidebar-toggle-button"><span></span><span></span><span></span></div></button><aside class="sidebar">' + (n.name ? '<h1 class="app-name"><a class="app-name-link" data-nosearch>' + (n.logo ? '<img alt="' + r + '" src=' + n.logo + ">" : r) + "</a></h1>" : "") + '<div class="sidebar-nav">\x3c!--sidebar--\x3e</div></aside>') + '<section class="content"><article class="markdown-section" id="main">\x3c!--main--\x3e</article></section></main>'), e._renderTo(c, u, !0)) : e.rendered = !0, t.mergeNavbar && h ? p = k(".sidebar") : (l.classList.add("app-nav"), t.repo || l.classList.add("no-badge")), t.loadNavbar && _(p, l), t.themeColor && (m.head.appendChild(x("div", "<style>:root{--theme-color: " + t.themeColor + ";}</style>").firstElementChild), o = t.themeColor, window.CSS && window.CSS.supports && window.CSS.supports("(--v:red)") || (t = w("style:not(.inserted),link"), [].forEach.call(t, function (e) {
            if ("STYLE" === e.nodeName) W(e, o); else if ("LINK" === e.nodeName) {
    ...
    var Pn = function (r) {
        ...
        return t && (e.__proto__ = t), ((e.prototype = Object.create(t && t.prototype)).constructor = e).prototype.getCurrentPath = function () {
            ...
            void 0 === n && (n = u), S("click", function (e) {
                ...
                "A" !== t.tagName || /_blank/.test(t.target) || (e.preventDefault(), t = t.href, -1 !== r.config.crossOriginLinks.indexOf(t) ? window.open(t, "_self") : window.history.pushState({key: t}, "", t), n({
                    event: e,
                    source: "navigate"
                }))
            ...
            var r = le(location.origin), n = e.indexOf(r);
    ...
    Vn._init = function () {
        ...
        V(this, "beforeEach", r, function (e) {
            ...
            var n;
            o.isHTML ? (n = o.result = r, t(), a()) : On({compiler: o.compiler, raw: e}, function (e) {
        ...
        var a = this;
        void 0 === i && (i = u);
        var e = this.config, t = e.requestHeaders, o = e.fallbackLanguages, s = e.loadSidebar;
        if (!o) return !1;
        e = n.split("/")[1];
        ...
        var r = this;
        void 0 === n && (n = u);
        var i = this.config, a = i.loadSidebar, o = i.requestHeaders, i = i.notFoundPage,
